...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of pcie_reg_space_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins pcie_reg_space_0/S00_AXI]
	connect_bd_net [get_bd_pins pcie_reg_space_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pcie_reg_space_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins pcie_reg_space_0/S01_AXI]
	connect_bd_net [get_bd_pins pcie_reg_space_0/s01_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pcie_reg_space_0/s01_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pcie_reg_space_0_S00_AXI_* ]]
	puts $fp "set s00_axi_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pcie_reg_space_0_S01_AXI_* ]]
