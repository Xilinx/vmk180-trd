...
################################################################
# This is a generated script based on design: vmk180_es1_trd
#
...
# source vmk180_es1_trd_script.tcl
...
set design_name vmk180_es1_trd
...
{ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVAUX_PKG_103} {SUPPLY_NUM\
0}}\
     SMON_MEAS1 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN 0}\
{ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVAUX_PKG_104} {SUPPLY_NUM\
0}}\
     SMON_MEAS10 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN\
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVAUX_PKG_206}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_103}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_104}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_105}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_106}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_200}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_201}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVCC_PKG_202}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME VCCAUX_IO_PKG_306}\
{SUPPLY_NUM 0}}\
     SMON_MEAS47 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN\
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME VCCAUX_IO_PKG_406}\
{SUPPLY_NUM 0}}\
...
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME VCCAUX_SYSMON} {SUPPLY_NUM\
0}}\
     SMON_MEAS5 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN 0}\
{ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVAUX_PKG_201} {SUPPLY_NUM\
0}}\
     SMON_MEAS50 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN\
0} {ENABLE 0} {MODE {2 V unipolar}} {NAME VCCINT_PL} {SUPPLY_NUM 0}}\
...
{ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVAUX_PKG_202} {SUPPLY_NUM\
0}}\
...
0} {ENABLE 0} {MODE {4 V unipolar}} {NAME VCCO_PKG_306} {SUPPLY_NUM\
0}}\
     SMON_MEAS64 {{ALARM_ENABLE 0} {ALARM_LOWER 0.00} {ALARM_UPPER 2.00} {AVERAGE_EN\
0} {ENABLE 0} {MODE {4 V unipolar}} {NAME VCCO_PKG_406} {SUPPLY_NUM\
0}}\
...
{ENABLE 0} {MODE {2 V unipolar}} {NAME GT_AVAUX_PKG_205} {SUPPLY_NUM\
0}}\
...
connect_bd_intf_net -intf_net [get_bd_intf_nets display_pipe_vmix_mm_axi_vid_rd_2] [get_bd_intf_pins NOC_0/S14_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_2_AXI]
  ...
  connect_bd_intf_net -intf_net hier_0_M00_AXI [get_bd_intf_pins NOC_0/M00_AXI] [get_bd_intf_pins versal_cips_0/NOC_CPM_PCIE_0]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_accel0_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_3_AXI] [get_bd_intf_pins smartconnect_accel0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net versal_cips_0_LPD_AXI_NOC_0 [get_bd_intf_pins NOC_0/S06_AXI] [get_bd_intf_pins versal_cips_0/LPD_AXI_NOC_0]
  ...
  connect_bd_net -net hier_0_IRQ1_to_PS [get_bd_pins pcie_infra/IRQ1_to_PS] [get_bd_pins versal_cips_0/pl_ps_irq8]
  connect_bd_net -net hier_0_IRQ2_to_PS [get_bd_pins pcie_infra/IRQ2_to_PS] [get_bd_pins versal_cips_0/pl_ps_irq9]
  connect_bd_net -net hier_0_IRQ3_to_PS [get_bd_pins pcie_infra/IRQ3_to_PS] [get_bd_pins versal_cips_0/pl_ps_irq10]
  connect_bd_net -net hier_0_IRQ4_to_PS [get_bd_pins pcie_infra/IRQ4_to_PS] [get_bd_pins versal_cips_0/pl_ps_irq11]
  connect_bd_net -net hier_0_clk_out1 [get_bd_pins NOC_0/aclk10] [get_bd_pins axi_perf_mon_0/s_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_0_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_1_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_2_axi_aclk] [get_bd_pins axi_perf_mon_0/slot_3_axi_aclk] [get_bd_pins axi_vip_0/aclk] [get_bd_pins axi_vip_1/aclk] [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins display_pipe/s_axis_aclk] [get_bd_pins rst_processor_150Mhz/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk2] [get_bd_pins smartconnect_accel0/aclk] [get_bd_pins smartconnect_gp2/aclk] [get_bd_pins versal_cips_0/m_axi_lpd_aclk]
  connect_bd_net -net hier_0_clk_out2 [get_bd_pins NOC_0/aclk12] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wizard_0/clk_out2] [get_bd_pins display_pipe/altclk] [get_bd_pins mipi_capture_pipe/s_axi_aclk] [get_bd_pins pcie_infra/s00_axi_aclk] [get_bd_pins rst_processor_150Mhz1/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins versal_cips_0/m_axi_fpd_aclk]
  connect_bd_net -net hier_0_csirxss_csi_irq [get_bd_pins mipi_capture_pipe/csirxss_csi_irq] [get_bd_pins versal_cips_0/pl_ps_irq5]
  connect_bd_net -net hier_0_iic2intc_irpt [get_bd_pins display_pipe/iic2intc_irpt] [get_bd_pins versal_cips_0/pl_ps_irq0]
  connect_bd_net -net hier_0_iic2intc_irpt1 [get_bd_pins mipi_capture_pipe/iic2intc_irpt] [get_bd_pins versal_cips_0/pl_ps_irq6]
  connect_bd_net -net hier_0_interrupt [get_bd_pins axi_perf_mon_0/interrupt] [get_bd_pins versal_cips_0/pl_ps_irq4]
  connect_bd_net -net hier_0_interrupt1 [get_bd_pins mipi_capture_pipe/interrupt] [get_bd_pins versal_cips_0/pl_ps_irq7]
  connect_bd_net -net hier_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins versal_cips_0/pl_ps_irq12]
  connect_bd_net -net hier_0_irq1 [get_bd_pins display_pipe/irq] [get_bd_pins versal_cips_0/pl_ps_irq1]
  connect_bd_net -net hier_0_irq2 [get_bd_pins display_pipe/irq1] [get_bd_pins versal_cips_0/pl_ps_irq2]
  connect_bd_net -net hier_0_vmix_intr [get_bd_pins display_pipe/vmix_intr] [get_bd_pins versal_cips_0/pl_ps_irq3]
  ...
  set_property PFM_NAME {xilinx.com:vmk180_es1_trd:vmk180_es1_trd:1.0} [get_files [current_bd_design].bd]
