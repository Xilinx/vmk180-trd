...
#. Create a new PetaLinux project from the provided BSP:
   ...
   .. code-block:: bash
      ...
      cd petalinux
      petalinux-create -t project -s xilinx-vmk180-trd-2020.2.bsp
      cd xilinx-vmk180-trd-v2020.2
...
#. Configure and build the PetaLinux project.
   ...
   .. note::
       ...
       .. code-block:: bash
          ...
          petalinux-config --get-hw-description=../../accelerators/examples/filter2d_pl/ --silentconfig
