...
/**
 * @brief provides number dma allocated
 *
 * @param[in] fpga_fd pcie ep device node file descriptor.
 *
 * @return number of dma allocated
 */
...
/**
 * @brief read write transfer done
 * 
 * @param[in] usecase type.
 *
 */
void read_write_transfer_done (gint fpga_fd, gint usecase);

/**
 * @brief get export fd size
 * 
 * @param[in] framesize based on resolution.
 *
 */
